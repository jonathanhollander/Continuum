<script lang="ts">
    ...
    import { Sparkles, MessageCircle, LayoutGrid, ArrowRight, Check } from 'lucide-svelte';
        ...
        {#if ready}
            <div class="w-full max-w-xl" in:fade={{ duration: 400 }}>
                ...
                <div class="text-center space-y-6">
                    <div class="mx-auto w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-indigo-500/30">
                        <Sparkles size={32} />
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <p class="text-slate-400 text-lg max-w-md mx-auto">
                            A gentle space to organize what matters most for the people you love.
                        </p>
                    </div>

                    <!-- Name Input Section -->
                    <div class="pt-4 space-y-4 max-w-sm mx-auto" in:fly={{ y: 20, duration: 400, delay: 200 }}>
                        <div class="space-y-2">
                            <label for="name-input" class="block text-sm text-slate-400 text-left">
                        ...
                        {:else}
                            <!-- Confirmed state -->
                            <div class="flex items-center justify-center gap-2 text-emerald-400 py-2" in:fade={{ duration: 200 }}>
                                <Check size={18} />
                                <span class="text-sm">Nice to meet you, {displayName}!</span>
                            </div>
                        {/if}
                    </div>
                </div>
                ...
                {#if nameSubmitted}
                    <div class="mt-12 space-y-6" in:fly={{ y: 30, duration: 400, delay: 100 }}>
                        <div class="text-center">
                            <h2 class="text-xl font-medium text-white">
                                How would you like to get started?
                            </h2>
                            <p class="text-slate-400 text-sm mt-1">
                                Choose whichever feels right - you can always change your approach.
                            </p>
                        </div>
                        ...
                        <div class="grid gap-4">
                            ...
                            >
                                <div class="flex items-start gap-4">
                                    <div class="p-2.5 bg-indigo-500 rounded-xl text-white shrink-0">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-sm text-slate-400">
                                            Have a friendly conversation to capture your important information step by step.
                                        </p>
                                    </div>
                                </div>
                            </button>
                            ...
                            >
                                <div class="flex items-start gap-4">
                                    <div class="p-2.5 bg-slate-700 rounded-xl text-slate-300 shrink-0 group-hover:bg-slate-600">
                                        <LayoutGrid size={22} />
                                    </div>
                                    <div class="space-y-1">
                                        <h3 class="font-medium text-white">I'll explore on my own</h3>
                                        <p class="text-sm text-slate-400">
                                            Start with your contacts and explore the modules at your own pace.
                                        </p>
                                    </div>
                                </div>
                            </button>
